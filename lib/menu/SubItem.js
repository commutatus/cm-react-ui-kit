...
var MenuSubItem = function (_React$Component) {
  ...
  function MenuSubItem(props) {
    ...
    _this.onMouseEnter = function (e) {
      ...
      _this.setState({ showMore: true, showTransition: true });
    };
  ...
  _createClass(MenuSubItem, [{
    ...
    value: function render() {
      ...
      var _state = this.state,
          ...
          showTransition = _state.showTransition;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'item-title menu-list ' + (showMore ? 'menu-list-active' : ''), onClick: this.handleClick },
          this.props.title
        ),
        showTransition && _react2.default.createElement(
          _reactTransitionGroup.CSSTransition,
          {
            ...
            onExited: function onExited() {
              return _this2.setState({ showTransition: false });
            }
          },
          _react2.default.createElement(
            'div',
