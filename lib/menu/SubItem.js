...
var MenuSubItem = function (_React$Component) {
  ...
  function MenuSubItem(props) {
    ...
    _this._getStyle = function (dimensions) {
      ...
      if ((dimensions.right > window.screenWidth * 75) / 100) {
        return { right: dimensions.left, top: _this.top };
      }
      return { left: dimensions.right, top: _this.top };
    };
  ...
  _createClass(MenuSubItem, [{
    ...
    value: function componentDidMount() {
      ...
      if (elem) this.dimensions = elem.getBoundingClientRect();
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        (showMore || true) && _react2.default.createElement(
          'div',
          { className: 'sub-item-list', style: _extends({}, this._getStyle(this.dimensions), { width: 100, position: 'absolute' }) },
